		...
		if ( isset( $item[ 'bundled_by' ] ) ) {
			...
			foreach ( $order->get_items() as $order_item ) {
				...
				if ( $is_parent ) {
					...
					$per_product_priced_bundle 	= $parent_item[ 'per_product_pricing' ];
			...
			$per_product_pricing = ! empty( $parent_item ) && isset( $per_product_priced_bundle ) ? $per_product_priced_bundle : get_post_meta( $bundle_product_id, '_per_product_pricing_active', true );
